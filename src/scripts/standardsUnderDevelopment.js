document.addEventListener('DOMContentLoaded', () => {
    const paginationBullets = document.querySelectorAll('.standards-under-development__pagination span')
    const table = document.querySelector('.standards-under-development__table')
