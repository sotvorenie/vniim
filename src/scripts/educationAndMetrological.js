document.addEventListener('DOMContentLoaded', () => {
    const paginationBullets = document.querySelectorAll('.education-and-metrological__pagination span')
    const table = document.querySelector('.education-and-metrological__table')
