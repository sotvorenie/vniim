document.addEventListener('DOMContentLoaded', () => {
    const paginationBullets = document.querySelectorAll('.test-center_characteristics__pagination span')
    const table = document.querySelector('.test-center_characteristics__table')
